    ...
    acceptabilityMap(acceptabilityMap): string[] {
        ...
        for (const key in acceptabilityMap) {
            if (acceptabilityMap.hasOwnProperty(key)) {
                ...
                switch (key) {
                    case '20581000087109': newMap.push('fr-CA:' + this.acceptabilityValue(value)); break;
                    case '19491000087109': newMap.push('en-CA:' + this.acceptabilityValue(value)); break;
                    case '900000000000508004': newMap.push('GB:' + this.acceptabilityValue(value)); break;
                    case '900000000000509007': newMap.push('US:' + this.acceptabilityValue(value)); break;
                    case '450828004': newMap.push('ES:' + this.acceptabilityValue(value)); break;
                    case '5641000179103': newMap.push('ES-UY:' + this.acceptabilityValue(value)); break;
                    case '554461000005103': newMap.push('DA:' + this.acceptabilityValue(value)); break;
                    case '46011000052107': newMap.push('SV:' + this.acceptabilityValue(value)); break;
                    case '32570271000036106': newMap.push('AU:' + this.acceptabilityValue(value)); break;
                    case '11000146104': newMap.push('NL:' + this.acceptabilityValue(value)); break;
                    case '31000146106': newMap.push('NL:' + this.acceptabilityValue(value)); break;
                    case '31000172101': newMap.push('NL:' + this.acceptabilityValue(value)); break;
                    case '15551000146102': newMap.push('NL-PF:' + this.acceptabilityValue(value)); break;
                    case '61000202103': newMap.push('NO-NB:' + this.acceptabilityValue(value)); break;
                    case '91000202106': newMap.push('NO-NN:' + this.acceptabilityValue(value)); break;
                    case '21000172104': newMap.push('FR:' + this.acceptabilityValue(value)); break;
                    case '21000220103': newMap.push('IE:' + this.acceptabilityValue(value)); break;
                    case '71000181105': newMap.push('ET:' + this.acceptabilityValue(value)); break;
                    case '281000210109': newMap.push('NZ-PF:' + this.acceptabilityValue(value)); break;
                    case '271000210107': newMap.push('NZ:' + this.acceptabilityValue(value)); break;
                    case '722128001': newMap.push('ZH:' + this.acceptabilityValue(value)); break;
                    case '291000210106': newMap.push('MI:' + this.acceptabilityValue(value)); break;
                    case '21000241105': newMap.push('FR:' + this.acceptabilityValue(value)); break;
                    case '722130004': newMap.push('DE:' + this.acceptabilityValue(value)); break;
                }
            }
        }
